...
public class QrCodeUtils {
     ...
     * @throws Exception
     */
    public static void encode(String content, String logoPath, String targetPath, boolean needCompress)
            throws Exception {
        BufferedImage image = QrCodeUtils.createImage(content, logoPath, needCompress);
        //生成的二维码写到保存路径中
        ImageIO.write(image, FORMAT, Files.newOutputStream(Paths.get(targetPath)));
    }
